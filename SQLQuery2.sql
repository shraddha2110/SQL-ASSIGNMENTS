...
insert into tblemployee values('Tejal','Nashik',2)
insert into tblemployee values('Pallavi','Nashik',1)
insert into tblemployee values('Priyanka','Nashik',3)
insert into tblemployee values('Prachi','Nagpur',1)
insert into tblemployee values('Asmita','Nagpur',4)
insert into tblemployee values('Tanvi','Nagpur',1)
insert into tblemployee values('Rutuja','Banglore',4)
insert into tblemployee values('Neha','Banglore',5)
insert into tblemployee values('Virat','Banglore',4)
insert into tblemployee values('Rohit','Banglore',5)
